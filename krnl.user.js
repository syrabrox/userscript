// ==UserScript==
// THIS SCRIPT GOT MODEFIED
// License: CC BY-NC 4.0 / Credits: https://bypass.city/
// @name         [Working] krnl bypasser
// @namespace    KRNL
...
(() => {
  ...
  var config = {
    ...
    buildTime: "1/2/2025, 8:57:50 PM",
    branch: "release",
    release: "3f67766",
    installed: true,
    releaseTag: "14.0.1 (3f67766)",
...
@keyframes glow {
  ...
  var regexObjects = [
    ...
    {
      name: "loot-link",
      regex: /^https:\/\/(?:loot-link|loot-links|lootlabs|lootlinks|lootdest|links-loot|linksloot|lootlink)\.(?:com|co|org|net|info|gg)\/s\?./i,
      userscript_regex: [
        "*://lootlabs.gg/*",
        "*://loot-link.com/*",
        "*://loot-link.co/*",
      ...
      valid_url_regex: /^https:\/\/(?:loot-link|loot-links|lootlabs|lootlinks|lootdest|links-loot|linksloot|lootlink)\.(?:com|co|org|net|info|gg)\/s\?./i,
  ...
  var linksListner = async () => {
    let matchData = match(window.location.href);
